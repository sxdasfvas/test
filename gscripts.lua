...
_G.GMAIL_ITEMS = {
  ...
  ["Cove Lockpick"] = {Class = "Misc", Id = "Lockpick A", MinAmount = 10},
  ["Gold Lockpick"] = {Class = "Misc", Id = "Lockpick B", MinAmount = 2},
  ["Diamond Lockpick"] = {Class = "Misc", Id = "Lockpick C", MinAmount = 1},
  ["Normals"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 20},
  ["Shinies"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 5, IsShiny = true},
  ["Goldens"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 10, IsGold = true},
  ["Shiny Goldens"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 5, IsGold = true, IsShiny = true},
  ["RBs"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 15, IsRainbow = true},
  ["Shiny RBs"] = {Class = "Pet", Id = "Poinsettia Peacock", MinAmount = 5, IsRainbow = true, IsShiny = true},
